...
public final class ConstantClass {
	...
	public static final String EMAIL_REGISTRATION_ERROR_MSG = "EmailErrorRegistration";
	public static final String SUCCES_REGISTRATION_MSG = "Registration successful";
